<template>
  ...
  <div class="com-page1">
    ...
    <dv-decoration-5  :dur="myDur" style="width:1000px;margin-left: 300px;height:30px;"  />
    <!--    <el-container>-->
...
export default {
  ...
  methods:{
    drawLine(){
      ...
      var timeArr = []
      var confirmArr = []
      this.$axios.post('http://116.62.153.183/getEpidemicDataPr',{"country":"美国"}, config).then(res => {
