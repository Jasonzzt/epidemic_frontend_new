...
<!--      </ul>-->
      <el-descriptions title="自定义样式列表" :column="1" border>
        <el-descriptions-item label="编号" label-class-name="my-label" content-class-name="my-content">核酸检测点名称</el-descriptions-item>
        <el-descriptions-item label="1">同仁医院核酸检测点</el-descriptions-item>
        <el-descriptions-item label="2">苏州市</el-descriptions-item>
        <el-descriptions-item label="3">111</el-descriptions-item>
        <el-descriptions-item label="4" :contentStyle="{'text-align': 'right'}">江苏省苏州市吴中区吴中大道 1188 号</el-descriptions-item>
