...
<template>
  ...
  <div class="box" ref="echartsMap">
    ...
    <el-cascader
       ...
       style="margin-left:1000px ;color: #0A41C8;background: #0A41C8;border-color: #0A41C8;width: 180px;"></el-cascader>
    <el-cascader
        v-model="value2"
        :options="options"
        @change="drawPopIn"
        style="padding-top:120px;margin-left: 20px;border-color: #0A41C8;width: 180px"></el-cascader>
      </div>
  </div>
</template>
<script>
...
export default {
  ...
  data() {
        return {
          ...
          chart: null,
          bjData:[],
          dataProvince : [{name:"北京",stuNum:100,value:1}
      ],
