...
const WORLD_COUNTRIES = [
  ...
  { name: 'Czech Republic', abbreviation: 'CZ', translation: '捷克' },
  ...
  { name: 'Greenland', abbreviation: 'GL', translation: '格陵兰岛' },
  ...
  { name: 'Macao', abbreviation: 'MO', translation: '澳门' },
  { name: 'North Macedonia', abbreviation: 'MK', translation: '北马其顿' },
  ...
  { name: 'North Korea', abbreviation: 'KP', translation: '朝鲜' },
  ...
  { name: 'Rwanda', abbreviation: 'RW', translation: '卢旺达' },
  { name: 'Saint Helena', abbreviation: 'SH', translation: '圣赫勒拿' },
  {
  ...
  { name: 'Somalia', abbreviation: 'SO', translation: '索马里' },
